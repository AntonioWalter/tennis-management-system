-- Stampa del ranking(posizione e punti) delle giocatrici  del WTA e aggiornamento della posizione in ranking
...
WHERE EO.Nome = 'WTA' AND EO.Anno = 2025  -- Modifica: Filtra per WTA
