-- Stampa del ranking(posizione e punti) delle giocatrici  del ITF e aggiornamento della posizione in ranking
...
WITH Classifica AS (
    ...
    WHERE EO.Nome = 'ITF' AND EO.Anno = 2025  -- Modifica: Filtra per ITF
)
UPDATE Ranking R
